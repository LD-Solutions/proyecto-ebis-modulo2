<footer class="pie-pagina">
    <section class="col3">
        ...
        <div class="columna">
            ...
            <ol>
                <li>
                    <a href="ahorro.html">Calculadora de ahorro</a>
                </li>
                <li>
                    <a href="bolsa.html">Estado de la bolsa</a>
                </li>
                <li>
                    <a href="dashboard.html">Consulta tu portfolio</a>
                </li>
            </ol>
        </div>
        <div class="columna">
            ...
            <ol>
                <li>
                    <a href="formacion.html">Fórmate con nosotros</a>
                </li>
                <li>
                    <a href="noticias.html">Ponte al día de las noticias</a>
                </li>
                <li>
    ...
    <section class="pie-pagina__copy">
        <h2>
